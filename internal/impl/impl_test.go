...
func TestWriteUint(t *testing.T) {
	tests := []struct {
		...
		{"0xFFFF+1", 0xFFFF + 1, []byte{byte(typeUint), 0xFC, 0x00, 0x00, 0x01, 0x00}, false},
		{"0xFFFFFFFF+1", 0xFFFFFFFF + 1, []byte{byte(typeUint), 0xF8, 0x00, 0x00, 0x00, 0x00, 0x01, 0x00, 0x00, 0x00}, false},
	}
